        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-gray-900">Kilas Indonesia</h1>
          ...
          <div className="hidden md:flex items-center gap-4">
            <form className="relative">
              <input
                ...
                className="w-64 px-4 py-2 pr-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
              />
              <button
                type="submit"
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                href="#"
                className="w-8 h-8 flex items-center justify-center text-gray-500 hover:text-sky-500 transition-colors"
                aria-label="Twitter"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
